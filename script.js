document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      const isRequired = field.required || field.hasAttribute('required') || field.dataset.required === 'true';
  ...
  if (animatedElements.length > 0) {
    ...
    animatedElements.forEach(function (el, index) {
      ...
      el.style.transition = 'opacity 0.6s ease ' + (index % 5 * 0.1) + 's, transform 0.6s ease ' + (index % 5 * 0.1) + 's';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '508f0d05-7e4f-4937-bc7d-091d8add4525',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '508f0d05-7e4f-4937-bc7d-091d8add4525';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '508f0d05-7e4f-4937-bc7d-091d8add4525';
